                                                        ...
                                                        <tr>
                                                            <td class="panel-item"
                                                                ...
                                                                <p
                                                                    ...
                                                                    This payment is NOT VERIFIED</p>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                ...
                                                <tbody
                                                    ...
                                                    <tr>
                                                        <td align="left"
                                                            ...
                                                            Seminar: How To take Expressive Photos</td>
                                                        <td align="right"
                                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; color: #74787e; font-size: 15px; line-height: 18px; margin: 0; padding: 10px 0;">
                                                            Rp35.000</td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td align="left"
                                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; color: #74787e; font-size: 15px; line-height: 18px; margin: 0; padding: 10px 0;">
                                                            <strong
                                                                style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative;">TOTAL</strong>
                                                        </td>
                                                        <td align="right"
                                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; color: #74787e; font-size: 15px; line-height: 18px; margin: 0; padding: 10px 0;">
                                                            Rp35.000</td>
                                ...
                                <tr>
                                    <td class="content-cell" align="center"
                                        ...
                                        <p
                                            ...
                                            © 2020 NARASI 2020. All rights reserved.</p>
